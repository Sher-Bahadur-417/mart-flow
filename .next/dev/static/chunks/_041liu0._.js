...
;
;
function Providers({ children, initialTheme }) {
...
function persistCookies(preference, resolved) {
    const maxAge = 60 * 60 * 24 * 365;
    document.cookie = `${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$theme$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["THEME_COOKIE"]}=${preference}; path=/; max-age=${maxAge}; samesite=lax`;
    document.cookie = `${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$theme$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["THEME_RESOLVED_COOKIE"]}=${resolved}; path=/; max-age=${maxAge}; samesite=lax`;
}
...
function readStoredTheme(storageKey, fallback) {
    try {
        ...
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$theme$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isThemePreference"])(stored)) {
            return stored;
        }
    } catch  {
...
function ThemeProvider({ children, defaultTheme = "system", storageKey = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$theme$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["THEME_STORAGE_KEY"], initialTheme }) {
    _s();
    const fallback = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$theme$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isThemePreference"])(initialTheme) ? initialTheme : (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$theme$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isThemePreference"])(defaultTheme) ? defaultTheme : "system";
    const [theme, setThemeState] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"](fallback);
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLayoutEffect"]({
        "ThemeProvider.useLayoutEffect": ()=>{
            ...
            const onChange = {
                "ThemeProvider.useLayoutEffect.onChange": ()=>{
            ...
            return ({
                "ThemeProvider.useLayoutEffect": ()=>media.removeEventListener("change", onChange)
            })["ThemeProvider.useLayoutEffect"];
        }
    }["ThemeProvider.useLayoutEffect"], [
        fallback,
...
_s(ThemeProvider, "ye3G+vaaWg8bs0KET6YXjYwWV+E=");
_c = ThemeProvider;
function useTheme() {
    _s1();
...
const THEME_COOKIE = "martflow-theme";
const THEME_RESOLVED_COOKIE = "martflow-theme-resolved";
function isThemePreference(value) {
    return value === "light" || value === "dark" || value === "system";
}
function htmlThemeClass(resolved) {
...
//# sourceMappingURL=_041liu0._.js.map